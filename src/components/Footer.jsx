    ...
    <footer className="bg-white border-t border-gray-100 pt-16 pb-8">
      <div className="max-w-7xl mx-auto px-6">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-12 mb-12">
          ...
          {/* Coluna 2: Atalhos */}
          <div>
            <h4 className="text-sm font-black uppercase text-gray-900 tracking-widest mb-6">
              Navegação
            </h4>
          ...
          <div>
            ...
            <div className="flex gap-4">
              <a
                ...
                className="p-3 bg-gray-50 rounded-xl text-gray-400 hover:text-indigo-600 transition"
                target="_blank"
              ...
              <a
                ...
                className="p-3 bg-gray-50 rounded-xl text-gray-400 hover:text-gray-900 transition"
                target="_blank"
                rel="noopener noreferrer"
              >
                <Github size={20} />
        ...
        <div className="md:text-justify border-t border-gray-50 pt-8 flex text-center flex-col md:flex-row justify-between items-center gap-4">
